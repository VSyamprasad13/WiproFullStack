...
FOREIGN KEY (MEMBER_ID) REFERENCES MEMBERS(MEMBER_ID), -- FOREIGN KEY REPRESENTS THE RELATIONSHIP BETWEEN TWO OR MORE TABLES
 -- IT WILL MAP TO MEMBER ID OF MEMBERS TABLE
FOREIGN KEY (ISBN) REFERENCES BOOKS(ISBN) -- IT WILL MAP TO ISBN OF BOOKS TABLE
); 
